...
class RPSettingsPage
{
    ...
    public function add_plugin_page()
    {
		...
		add_submenu_page(
			...
			'Settings', 
			'manage_options', 
			'properties_settings', array( $this, 'create_rp_settings_page' ));
    }

    /**
     * Options page callback
     */
    public function create_rp_settings_page()
    {
        // Set class property
        ...
        <div class="wrap">
            ...
            <?php
                ...
                do_settings_sections( 'rp_settings' );
                submit_button(); 
            ?>
            </form>
        </div>
...
if( is_admin() )
    $my_settings_page = new RPSettingsPage();